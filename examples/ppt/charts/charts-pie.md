...
- **charts-pie.py** — build script (`python3 charts-pie.py`).
- **charts-pie.pptx** — generated deck.
- **charts-pie.md** — this file.
...
- [charts-column.md](charts-column.md), [charts-bar.md](charts-bar.md), [charts-line.md](charts-line.md)
