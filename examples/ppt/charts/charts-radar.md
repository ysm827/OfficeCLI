...
- **charts-radar.py** — build script (`python3 charts-radar.py`).
- **charts-radar.pptx** — generated deck.
- **charts-radar.md** — this file.
...
- [charts-stock.md](charts-stock.md), [charts-combo.md](charts-combo.md), [charts-waterfall.md](charts-waterfall.md), [charts-3d.md](charts-3d.md)
